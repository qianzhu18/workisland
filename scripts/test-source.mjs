...
// one managed PTY session, and a renderer-to-main file-drag interaction lock.
assert.equal(Object.keys(IPC).length, 137, "IPC contract changed; review both main and preload consumers");
