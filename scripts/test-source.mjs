...
// #28 (dock mode) was reverted; workstation media/performance adds nine channels.
assert.equal(Object.keys(IPC).length, 101, "IPC contract changed; review both main and preload consumers");
