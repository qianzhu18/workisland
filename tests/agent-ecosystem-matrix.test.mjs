...
for (const [agentId, adapter] of Object.entries({
  ...
  qoder: require("../src/main/adapters-work-agents.cjs").QoderAdapter,
  opencode: require("../src/main/adapters-ide.cjs").OpenCodeAdapter,
  dumate: require("../src/main/adapters-ide.cjs").DumateAdapter,
...
const scenarios = {
  ...
  qoder: { hook_event_name: "UserPromptSubmit", prompt: "matrix test" },
  opencode: { hook_event_name: "UserPromptSubmit", prompt: "matrix test" },
  dumate: { hook_event_name: "UserPromptSubmit", prompt: "matrix test" },
