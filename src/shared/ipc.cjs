...
const IPC = Object.freeze({
  ...
  SETTINGS_LIST_CUSTOM_AGENT_CONNECTIONS: "settings:list-custom-agent-connections",
  SETTINGS_PREVIEW_CUSTOM_AGENT_CONNECTION: "settings:preview-custom-agent-connection",
  SETTINGS_INSTALL_CUSTOM_AGENT_CONNECTION: "settings:install-custom-agent-connection",
  SETTINGS_UNINSTALL_CUSTOM_AGENT_CONNECTION: "settings:uninstall-custom-agent-connection",
